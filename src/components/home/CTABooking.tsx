...
export default function CTABooking() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[#1B3A6B]/88" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
          <Link href="/booking"
            className="inline-flex items-center justify-center gap-2 bg-[#D4A017] text-[#1B3A6B] px-8 py-4 rounded-xl font-bold text-base hover:bg-[#F5C842] transition-all shadow-lg hover:shadow-xl hover:scale-105">
