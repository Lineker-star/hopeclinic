...
export default function WorkingHours() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[#0F2347]/90" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-white/70 mb-6">
              We are here when you need us most. Our dedicated team is ready to provide
              compassionate care during working hours — and our emergency team is available
              around the clock.
            </p>
            ...
            {schedule.map(({ days, hours, emergency }) => (
              <div key={days}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Link href="/booking"
                    className="hidden sm:inline-flex text-xs bg-[#1B3A6B] text-white px-3 py-1.5 rounded-lg hover:bg-[#2952A3] transition-colors">
                    Book
                  </Link>
                </div>
              </div>
